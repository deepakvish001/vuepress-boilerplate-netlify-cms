...
Define the request timeouts standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.

## Acceptance criteria

- The request timeouts requirement is explicit and testable.
