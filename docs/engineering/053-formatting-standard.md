...
Define the formatting standard standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.
...
- The formatting standard requirement is explicit and testable.
