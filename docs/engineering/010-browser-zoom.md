...
Define the browser zoom standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.
...
- The browser zoom requirement is explicit and testable.
...
Keep implementation work focused on one browser zoom outcome and note any Netlify operator action in the pull request.