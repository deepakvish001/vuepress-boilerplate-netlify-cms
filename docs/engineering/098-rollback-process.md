...
Define the rollback process standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.

## Acceptance criteria

- The rollback process requirement is explicit and testable.
