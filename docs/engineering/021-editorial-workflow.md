...
Define the editorial workflow standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.
...
- The editorial workflow requirement is explicit and testable.
...
Keep implementation work focused on one editorial workflow outcome and note any Netlify operator action in the pull request.