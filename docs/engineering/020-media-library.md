...
Define the media library standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.
...
- The media library requirement is explicit and testable.
...
Keep implementation work focused on one media library outcome and note any Netlify operator action in the pull request.