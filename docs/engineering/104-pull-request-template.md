...
Define the pull request template standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.

## Acceptance criteria

- The pull request template requirement is explicit and testable.
