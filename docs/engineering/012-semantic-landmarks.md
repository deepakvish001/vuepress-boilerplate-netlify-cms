...
Define the semantic landmarks standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.
...
- The semantic landmarks requirement is explicit and testable.
...
Keep implementation work focused on one semantic landmarks outcome and note any Netlify operator action in the pull request.