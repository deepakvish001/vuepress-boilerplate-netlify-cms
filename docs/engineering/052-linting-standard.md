...
Define the linting standard standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.
...
- The linting standard requirement is explicit and testable.
