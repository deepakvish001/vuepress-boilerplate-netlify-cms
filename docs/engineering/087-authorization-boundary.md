...
Define the authorization boundary standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.

## Acceptance criteria

- The authorization boundary requirement is explicit and testable.
