...
Define the page metadata standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.

## Acceptance criteria

- The page metadata requirement is explicit and testable.
