...
Define the schema versioning standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.

## Acceptance criteria

- The schema versioning requirement is explicit and testable.
