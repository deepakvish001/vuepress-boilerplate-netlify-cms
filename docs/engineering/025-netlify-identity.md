...
Define the netlify identity standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.
...
- The netlify identity requirement is explicit and testable.
...
Keep implementation work focused on one netlify identity outcome and note any Netlify operator action in the pull request.