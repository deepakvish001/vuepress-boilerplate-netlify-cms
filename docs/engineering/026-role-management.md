...
Define the role management standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.
...
- The role management requirement is explicit and testable.
...
Keep implementation work focused on one role management outcome and note any Netlify operator action in the pull request.