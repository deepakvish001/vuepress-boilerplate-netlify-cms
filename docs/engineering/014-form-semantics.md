...
Define the form semantics standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.
...
- The form semantics requirement is explicit and testable.
...
Keep implementation work focused on one form semantics outcome and note any Netlify operator action in the pull request.