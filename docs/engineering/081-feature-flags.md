...
Define the feature flags standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.

## Acceptance criteria

- The feature flags requirement is explicit and testable.
