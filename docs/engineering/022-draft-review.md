...
Define the draft review standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.
...
- The draft review requirement is explicit and testable.
...
Keep implementation work focused on one draft review outcome and note any Netlify operator action in the pull request.