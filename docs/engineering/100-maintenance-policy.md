...
Define the maintenance policy standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.

## Acceptance criteria

- The maintenance policy requirement is explicit and testable.
