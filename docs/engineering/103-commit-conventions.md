...
Define the commit conventions standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.

## Acceptance criteria

- The commit conventions requirement is explicit and testable.
