...
Define the markdown frontmatter standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.
...
- The markdown frontmatter requirement is explicit and testable.
...
Keep implementation work focused on one markdown frontmatter outcome and note any Netlify operator action in the pull request.