...
Define the visual regression standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.
...
- The visual regression requirement is explicit and testable.
...
Keep implementation work focused on one visual regression outcome and note any Netlify operator action in the pull request.