...
Define the content security policy standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.
...
- The content security policy requirement is explicit and testable.
...
Keep implementation work focused on one content security policy outcome and note any Netlify operator action in the pull request.