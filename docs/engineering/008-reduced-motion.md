...
Define the reduced motion standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.
...
- The reduced motion requirement is explicit and testable.
...
Keep implementation work focused on one reduced motion outcome and note any Netlify operator action in the pull request.