...
Define the dependency updates standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.

## Acceptance criteria

- The dependency updates requirement is explicit and testable.
