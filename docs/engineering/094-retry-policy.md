...
Define the retry policy standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.

## Acceptance criteria

- The retry policy requirement is explicit and testable.
