...
Define the publish workflow standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.
...
- The publish workflow requirement is explicit and testable.
...
Keep implementation work focused on one publish workflow outcome and note any Netlify operator action in the pull request.