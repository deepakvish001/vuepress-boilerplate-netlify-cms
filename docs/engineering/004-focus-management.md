...
Define the focus management standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.
...
- The focus management requirement is explicit and testable.
...
Keep implementation work focused on one focus management outcome and note any Netlify operator action in the pull request.