...
Define the accessible names standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.
...
- The accessible names requirement is explicit and testable.
...
Keep implementation work focused on one accessible names outcome and note any Netlify operator action in the pull request.