...
Define the branch protection standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.

## Acceptance criteria

- The branch protection requirement is explicit and testable.
