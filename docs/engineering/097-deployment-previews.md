...
Define the deployment previews standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.

## Acceptance criteria

- The deployment previews requirement is explicit and testable.
