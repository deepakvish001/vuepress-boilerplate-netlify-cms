...
Define the browser matrix standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.
...
- The browser matrix requirement is explicit and testable.
...
Keep implementation work focused on one browser matrix outcome and note any Netlify operator action in the pull request.