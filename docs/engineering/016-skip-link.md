...
Define the skip link standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.
...
- The skip link requirement is explicit and testable.
...
Keep implementation work focused on one skip link outcome and note any Netlify operator action in the pull request.