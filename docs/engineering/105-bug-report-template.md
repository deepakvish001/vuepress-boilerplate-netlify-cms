...
Define the bug report template standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.

## Acceptance criteria

- The bug report template requirement is explicit and testable.
