...
Define the config testing standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.
...
- The config testing requirement is explicit and testable.
...
Keep implementation work focused on one config testing outcome and note any Netlify operator action in the pull request.