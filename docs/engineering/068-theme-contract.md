...
Define the theme contract standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.

## Acceptance criteria

- The theme contract requirement is explicit and testable.
