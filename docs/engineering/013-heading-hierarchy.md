...
Define the heading hierarchy standard for DocuPress CMS so VuePress content and Netlify CMS editorial changes remain secure, reviewable, and deployable.
...
- The heading hierarchy requirement is explicit and testable.
...
Keep implementation work focused on one heading hierarchy outcome and note any Netlify operator action in the pull request.